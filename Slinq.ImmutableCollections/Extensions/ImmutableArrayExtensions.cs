//------------------------------------------------------------------------------
// <auto-generated>look at the ImmutableArrayExtensionsGenerator.tt</auto-generated>
//------------------------------------------------------------------------------
using System;
...
namespace Slinq.Extensions
{
    public static class ImmutableArrayExtensions
    {
        ...
        public static T Single<T>(this ImmutableArray<T> source, Predicate<T> predicate)
        {
        ...
        public static T SingleOrDefault<T>(this ImmutableArray<T> source)
        {
            return ArrayProvider<T>.Extract(source).SingleOrDefault();
        }

        public static T SingleOrDefault<T>(this ImmutableArray<T> source, Predicate<T> predicate)
        {
            var extractedArray = ArrayProvider<T>.Extract(source);
            if (!extractedArray.IsAsLongAsSourceArray)
            {
